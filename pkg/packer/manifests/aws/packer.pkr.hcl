...
=======
      version = ">= 1.1.1"
>>>>>>> a6d4951 (feature: HCL translate aws-ami)
...
data "amazon-ami" "autogenerated_1" {
  ...
  most_recent = true
  owners      = split(",", var.ami_filter_owners)
...
=======
  ami_name             = "konvoy-ami-${var.build_name}-${var.kubernetes_full_version}-${local.build_timestamp}"
>>>>>>> a6d4951 (feature: HCL translate aws-ami)
