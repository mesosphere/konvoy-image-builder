...
const (
	...
	PackerVSphereISOISOURL                    = "/packer/iso_url"
	PackerVSphereISOISOChecksum               = "/packer/iso_checksum"
	PackerVSphereISOVCenterServer             = "/packer/vcenter_server"
	PackerVSphereISOVSphereUser               = "/packer/vsphere_user"
	PackerVSphereISOVSpherePassword           = "/packer/vsphere_password"
	PackerVSphereISOVSphereInsecureConnection = "/packer/insecure_connection"
	PackerVSphereISOVSphereClusterName        = "/packer/cluster"
	PackerVSphereISOVSphereDataStoreName      = "/packer/datastore"
	PackerVSphereISOVSphereFolder             = "/packer/folder"
	PackerVSphereISOVSphereResourcePool       = "/packer/resource_pool"
	PackerVSphereISOVSphereDataCenter         = "/packer/datacenter"
	PackerVSphereISOVSphereNetwork            = "/packer/network"
	PackerVSphereISOSSHUsername               = "/packer/ssh_username"
