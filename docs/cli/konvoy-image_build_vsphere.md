...
```
      ...
      --datastore string             vSphere datastore used to build and store the image template (REQUIRED)
  ...
  -h, --help                         help for vsphere
      ...
      --network string               vSphere network used to build image template. Ensure the host running the command has access to this network (REQUIRED)
