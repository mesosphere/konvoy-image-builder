...
PROD_VSPHERE_URL=${PROD_VSPHERE_URL:="vcenter.ca1.ksphere-platform.d2iq.cloud"}
...
PROD_TEMPLATE_NAME=${PROD_TEMPLATE_NAME:="konvoy-rhel-84-release-1.26.6-20230620174529"}


VCD_URL=${VCD_URL:="vcd.hw.ovh-ca.d2iq.cloud"}
VCD_USERNAME=${VCD_USERNAME:=""}
VCD_PASSWORD=${VCD_PASSWORD:=""}
VCD_ORG=${VCD_ORG:="konvoy"}
VCD_ORG_CATALOG=${VCD_ORG_CATALOG:="default"}
